...
describe Table do
  ...
  it 'should have a minimum x equals to 0' do
    expect(table.instance_variable_get(:@min_x)).to eq(0)
  end

  it 'should have a minimum y equals to 0' do
    expect(table.instance_variable_get(:@min_y)).to eq(0)
  end

  it 'should have a maximum x equals to 5' do
    expect(table.instance_variable_get(:@max_x)).to eq(5)
  end

  it 'should have a maximum y equals to 5' do
